    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Course Us!<sup></sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePengajar" aria-expanded="true" aria-controls="collapsePengajar">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Pengajar</span>
                </a>
                <div id="collapsePengajar" class="collapse" aria-labelledby="headingPengajar" data-parent="#accordionSidebar">
