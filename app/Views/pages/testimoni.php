  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-end justify-content-center">
      <div class="col-md-9 ftco-animate pb-5 text-center">
        <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Beranda <i class="fa fa-chevron-right"></i></a></span> <span>Testimoni <i class="fa fa-chevron-right"></i></span></p>
    ...
    <div class="row">
      ...
      <div class="col-md-3 d-flex justify-content-center counter-wrap ftco-animate">
        <div class="block-18 d-flex align-items-center">
          ...
          <div class="text">
            <strong class="number" data-number="7500">0</strong>
            ...
            <div class="testimony-wrap py-4">
              <div class="text">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="pl-3">
                    <p class="name">Khalifah Nasif</p>
                    <span class="position">Taruna Akpol</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="testimony-wrap py-4">
              <div class="text">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="pl-3">
                    <p class="name">Jevo Batara</p>
                    <span class="position">Taruna Poltekim</span>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="row justify-content-center">
      <div class="col-md-12 text-center">
        <div class="img" style="background-image: url(images/bg_4.jpg);">
          <div class="overlay"></div>
          <h2>We Are Course Us An Online Learning Center</h2>
          <p>Kami membimbing anda untuk masuk ke sekolah kedinasan impian</p>
          <p class="mb-0"><a href="#" class="btn btn-primary px-4 py-3">Daftar Sekarang</a></p>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="col-md-6 heading-section pr-md-5 ftco-animate d-flex align-items-center">
        <div class="w-100 mb-4 mb-md-0">
          ...
          <div class="d-flex video-image align-items-center mt-md-4">
            ...
            <h4 class="ml-4">Learn anything from CourseUs, Watch video</h4>
          </div>
        </div>
      </div>
      <div class="col-md-6">
