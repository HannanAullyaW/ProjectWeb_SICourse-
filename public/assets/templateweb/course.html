				...
				<div class="row mb-5">
					<div class="col-md pt-5">
						<div class="ftco-footer-widget pt-md-5 mb-4">
							...
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In id arcu efficitur, maximus turpis sit amet, blandit odio. Donec ultrices consequat leo, at lobortis leo suscipit et. Nullam ac dui quis odio imperdiet ullamcorper ac vel nunc.</p>
					...
					<div class="col-md pt-5">
						<div class="ftco-footer-widget pt-md-5 mb-4">
							...
							<ul class="list-unstyled">
								<li><a href="#" class="py-2 d-block">TWK (Tes Wawasan Kebangsaan)</a></li>
								<li><a href="#" class="py-2 d-block">TIU (Tes Intelegensi Umum)</a></li>
								<li><a href="#" class="py-2 d-block">TKP (Tes Kemampuan Pribadi)</a></li>
							</ul>
						</div>
					</div>
					<div class="col-md pt-5">
						<div class="ftco-footer-widget pt-md-5 mb-4">
							...
							<div class="block-23 mb-3">
								<ul>
									...
									<li><a href="#"><span class="icon fa fa-phone"></span><span class="text">+62 859 0040 8707</span></a></li>
									<li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text">info@courseus.com</span></a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12 text-center">
						...
						<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Course Us!</a>
